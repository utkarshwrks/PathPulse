...
**`data/routes/`** — generated by `scripts/make-routes.mjs` so lengths and turn
counts are exact, not approximated:
- `route_city.json` — **1997.8 m**, four 90° turns, three stops
- `route_highway.json` — **2996.3 m**, straight → long sweeping curve → straight
...
| `sensor-sources` | 31 — simulation (20), replay/recording (11) |
